...
/* Fix: placeholder text had no explicit color, so it fell back to the
   browser's default — which often has poor contrast against our translucent
   dark input backgrounds specifically (fine on light backgrounds, hard to
   read on dark ones). This is very likely what "text not visible in dark
   theme" was pointing at. */
...
/* Fix: numbers used to only appear on hover (Chart.js tooltip). This is a
   plain HTML/CSS bar list instead, so the exact count is always visible
   next to every item with no hover needed, and it's trivial to show all
   items (not just top 10) via the "View all" toggle. */
.card-head-row { display: flex; justify-content: space-between; align-items: center; gap: 10px; flex-wrap: wrap; margin-bottom: 14px; }
.card-head-row h3 { margin-bottom: 0; }
.btn-ghost.small { padding: 6px 12px; font-size: 12px; }
.bar-list { display: flex; flex-direction: column; gap: 10px; max-height: 420px; overflow-y: auto; }
.bar-row { display: flex; align-items: center; gap: 10px; font-size: 13px; }
.bar-name { width: 150px; flex-shrink: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--text); }
.bar-track { flex: 1; height: 20px; background: var(--surface-2); border-radius: 6px; overflow: hidden; min-width: 40px; }
.bar-fill { height: 100%; background: linear-gradient(90deg, #7c6bff, #00d4b1); border-radius: 6px; transition: width .3s ease; min-width: 3px; }
.bar-value { width: 44px; flex-shrink: 0; text-align: right; font-weight: 700; color: var(--text); font-variant-numeric: tabular-nums; }
@media (max-width: 600px) {
  .bar-name { width: 90px; font-size: 12px; }
}
...
/* Fix: on narrow phones the topbar (menu icon + title + search + 3 action
   icons) could exceed the screen width and overflow. The page title is
   redundant with the active sidebar item, so it's hidden here to make
   room, and padding/search width are tightened. */
@media (max-width: 480px) {
  .topbar { padding: 10px 12px; gap: 8px; }
  .topbar .title { display: none; }
  .search-wrap { max-width: 100px; padding: 6px 10px; }
...
<div id="loginView" class="login-view">
  <div class="login-card">
    <div class="logo"><img src="data:image/png;base64," alt="Fast Web Tools" style="width:64px;height:64px;border-radius:16px;object-fit:cover;"></div>
    <h1>FastWebTools</h1>
    ...
    <div class="field">
      ...
      <div class="input-wrap">
        ...
        <input type="text" id="username" placeholder="Enter username" autocomplete="username" autocapitalize="none" autocorrect="off" spellcheck="false" inputmode="text">
      </div>
    </div>
    <div class="field">
...
<div id="appView" class="app-view hidden">
  <aside class="sidebar" id="sidebar">
    <div class="brand"><img src="data:image/png;base64," alt="Fast Web Tools" style="width:26px;height:26px;border-radius:6px;object-fit:cover;"> FastWebTools</div>
    <nav>
  ...
  <div class="main-wrap">
    <header class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <span class="avatar" id="userAvatar"><img src="data:image/png;base64," alt="Fast Web Tools" style="width:100%;height:100%;object-fit:cover;border-radius:50%;"></span>
      </div>
    </header>
      ...
      <div class="page active" id="page-overview">
        ...
        <div class="card" style="margin-bottom:20px;">
          <div class="card-head-row">
            <h3>Tool usage by name</h3>
            <button class="btn-ghost small" id="toggleAllTools">View all</button>
          </div>
          <div id="toolUsageList" class="bar-list"><div style="padding:20px;text-align:center;color:var(--text-dim);"><i class="fa-solid fa-spinner fa-spin"></i></div></div>
        </div>
        <div class="card" style="margin-bottom:20px;">
          <div class="card-head-row">
            <h3>Blog views (which blog is being read)</h3>
            <button class="btn-ghost small" id="toggleAllArticles">View all</button>
          </div>
          <div id="articleViewsList" class="bar-list"><div style="padding:20px;text-align:center;color:var(--text-dim);"><i class="fa-solid fa-spinner fa-spin"></i></div></div>
        </div>
      </div>
...
async function getPopularArticles() { return apiCall('/popular-articles?limit=100'); }
// Fix: the real backend's /admin/comments only understands 'limit' and
// 'offset' — it has no concept of 'page' at all. Sending 'page' meant the
// backend silently ignored it and always returned offset 0 (the same
// first 20 rows), no matter which page button was clicked. Now computes
// and sends the correct offset instead.
...
// Fix: there was no <form> and no keydown handling at all — pressing
// Enter in either field silently did nothing, forcing a manual tap on
// the Sign In button every single time.
...
// Fix #7 (root cause confirmed): the real backend (fastwebtools-admin)
// does not implement /admin/visitors/realtime at all — there is no visitor
// tracking table in the database. Polling it will always fail. Rather than
// leave a permanently-wrong "0 live now" (which looks like real live data
// that's just stuck), show "–" once we know the endpoint isn't there, so
// it's honest about not being tracked yet instead of silently lying.
...
async function pollLiveCounter() {
  try {
    ...
    if (live !== undefined) { $('liveCount').textContent = fmtNum(live); return; }
    $('liveCount').textContent = '–';
  } catch (e) {
    // Endpoint not implemented on the backend yet — show "not tracked"
...
// ===== OVERVIEW =====
// Fix #1 (root cause confirmed by inspecting the live backend + database):
// /admin/stats actually returns { success, stats: { total_comments,
// articles_liked, total_article_likes, tools_liked, total_tool_likes,
// tools_used, total_tool_uses } }. Two bugs before: (a) the code unwrapped
// "data" instead of "stats", so it was reading the wrong object entirely;
// (b) "Total Likes" and "Tool Usage" were guessed field names that don't
// exist — the real backend splits likes into article-likes vs tool-likes
// (no single combined field), and calls tool usage "total_tool_uses", not
// "toolUsage". There is also no visitor-tracking table in the database at
// all, so "Total Visitors" genuinely has no real data yet — showing "–"
// instead of a fake 0 is the honest state until that feature is built.
async function loadOverview() {
  try {
    var raw = await getStats();
    var stats = raw && raw.stats ? raw.stats : (raw && raw.data ? raw.data : raw);
    var grid = $('statsGrid');
    var totalComments = pick(stats, 'total_comments', 'totalComments', 'comments', 'commentCount');
    var articleLikes = pick(stats, 'total_article_likes', 'article_likes') || 0;
    var toolLikes = pick(stats, 'total_tool_likes', 'tool_likes') || 0;
    var totalLikes = (articleLikes || toolLikes) ? (Number(articleLikes) + Number(toolLikes)) : pick(stats, 'totalLikes', 'total_likes', 'likes');
    var toolUsage = pick(stats, 'total_tool_uses', 'toolUsage', 'tool_usage', 'usage');
    var hasVisitorData = pick(stats, 'totalVisitors', 'total_visitors', 'visitors') !== undefined;
    var items = [
      { label: 'Total Visitors', value: hasVisitorData ? pick(stats, 'totalVisitors', 'total_visitors', 'visitors') : '–', icon: 'fa-eye', notTracked: !hasVisitorData },
      { label: 'Total Comments', value: totalComments !== undefined ? totalComments : 0, icon: 'fa-comments' },
      { label: 'Total Likes', value: totalLikes !== undefined ? totalLikes : 0, icon: 'fa-heart' },
      { label: 'Tool Usage', value: toolUsage !== undefined ? toolUsage : 0, icon: 'fa-toolbox' },
    ];
...
// Fix: Chart.js tooltips only showed the exact number on hover, which is
// annoying to check one-by-one, and the doughnut ("Top tools") was showing
// the exact same information as the tool-usage list right below it — just
// less readably. Both are now one plain HTML/CSS bar-list system: the exact
// count is always visible next to every row, no hover needed, and there's
// a "View all" toggle instead of being capped at whatever the chart could
// fit. The same system also powers the new "Blog views" section.
var lastPopularTools = [];
var lastPopularArticles = [];
var showAllTools = false;
var showAllArticles = false;

function renderBarListInto(containerId, items, showAll, labelFn, valueFn, emptyMsg) {
  var el = document.getElementById(containerId);
  if (!el) return;
  if (!items.length) {
    el.innerHTML = '<div style="padding:20px;text-align:center;color:var(--text-dim);">' + emptyMsg + '</div>';
    return;
  }
  var visible = showAll ? items : items.slice(0, 10);
  var max = 1;
  items.forEach(function(it) { var v = valueFn(it); if (v > max) max = v; });
  el.innerHTML = visible.map(function(item) {
    ...
    return '<div class="bar-row"><span class="bar-name" title="' + escapeHtml(name) + '">' + escapeHtml(name) + '</span>' +
      '<span class="bar-track"><span class="bar-fill" style="width:' + pct + '%"></span></span>' +
      '<span class="bar-value">' + fmtNum(value) + '</span></div>';
  }).join('');
}

function toolLabel(t) { return pick(t, 'name', 'id', 'tool') || 'Tool'; }
function toolValue(t) { return Number(pick(t, 'uses', 'count', 'usage')) || 0; }
function articleLabel(a) { return pick(a, 'name', 'id', 'article', 'title') || 'Article'; }
function articleValue(a) { return Number(pick(a, 'count', 'views', 'uses')) || 0; }

function renderToolBars() {
  renderBarListInto('toolUsageList', lastPopularTools, showAllTools, toolLabel, toolValue, 'No tool usage yet');
  var btn = $('toggleAllTools');
  if (lastPopularTools.length > 10) {
    btn.classList.remove('hidden');
    btn.textContent = showAllTools ? 'Show top 10' : 'View all (' + lastPopularTools.length + ')';
  } else {
    btn.classList.add('hidden');
  }
}

function renderArticleBars() {
  renderBarListInto('articleViewsList', lastPopularArticles, showAllArticles, articleLabel, articleValue,
    'No views recorded yet — once the visit-tracking snippet is live on your blog, this fills in automatically.');
  var btn = $('toggleAllArticles');
  if (lastPopularArticles.length > 10) {
    btn.classList.remove('hidden');
    btn.textContent = showAllArticles ? 'Show top 10' : 'View all (' + lastPopularArticles.length + ')';
  } else {
    btn.classList.add('hidden');
  }
}

async function renderToolUsageList() {
  try {
    var resp = await getPopularTools();
    lastPopularTools = resp && resp.tools ? resp.tools : (Array.isArray(resp) ? resp : []);
    renderToolBars();
  } catch (e) {
    $('toolUsageList').innerHTML = '<div style="padding:20px;text-align:center;color:var(--danger);">Failed to load tool usage: ' + escapeHtml(e.message) + '</div>';
  }
}

// New: which blog/article is actually being read, same bar-list style as
// tool usage, backed by real page-view data from the visits table.
async function renderArticleViewsList() {
  try {
    var resp = await getPopularArticles();
    lastPopularArticles = resp && resp.articles ? resp.articles : (Array.isArray(resp) ? resp : []);
    renderArticleBars();
  } catch (e) {
    $('articleViewsList').innerHTML = '<div style="padding:20px;text-align:center;color:var(--danger);">Failed to load blog views: ' + escapeHtml(e.message) + '</div>';
  }
}

$('toggleAllTools').onclick = function() { showAllTools = !showAllTools; renderToolBars(); };
$('toggleAllArticles').onclick = function() { showAllArticles = !showAllArticles; renderArticleBars(); };
...
// Fix: previously, a saved-but-expired token would show the full dashboard
// UI immediately, only to bounce back to login a moment later once the
// first API call (stats) returned 401 — a confusing flash for the user.
// Now the token is verified up front, so an expired session goes straight
// to a clean login screen with a clear message instead.
(async function initAuth() {
  ...
  try {
    ...
    // apiCall already handled cleanup (cleared the token, hid the app,
    // showed the login view) if this was a 401 — this just explains why.
